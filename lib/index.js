...
function HttpProxyMiddleware(context, opts) {
  ...
  function __applyPathRewrite(req, pathRewriter) {
    ...
    if (pathRewriter) {
      console.log(`http-proxy-middleware, __applyPathRewrite, reqData before pathRewriter:${reqData}`);
      var path = pathRewriter(req.url, req)
      console.log(`http-proxy-middleware, __applyPathRewrite, reqData after pathRewriter:${reqData}`);
